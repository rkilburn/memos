...
export type UserWebhook = Message<"memos.api.v1.UserWebhook"> & {
   ...
   *
   * @generated from field: string memo_filter = 6;
   */
  memoFilter: string;
};
